...
const lines=db.prepare("SELECT date_maturity, date, amount_residual FROM move_lines WHERE account_type='asset_receivable' AND parent_state='posted' AND account_id_code != 'Trade'").all(); 
...
console.log('My column totals:', buckets);
